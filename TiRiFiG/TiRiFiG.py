                        ...
                        if (
                            ...
                            if np.subtract(max(self.parVals), min(self.parVals)) == 0:
                                ...
                                self.yScale = [
                                    ...
                                    0.1 * (max(self.parVals) - min(self.parVals)))),
...
class MainWindow(QtGui.QMainWindow): 
    ...
    def cleanUp(self):
        ...
        # TODO(Samuel 11-06-2018): Find a way to do this better
        ...
        # TODO use Lib/tempfile.py to create temporary file
    ...
    def openDef(self):
        ...
        try:
            ...
            self.data = data
            if self.runNo > 0:
                # TODO reloading another file on already opened not properly working
                # user has to close open window and reopen file for such a case
                QtGui.QMessageBox.information(self, "Information",
                        "Close app and reopen to load file. Bug being fixed")
                # self.cleanUp()
                # TODO(Samuel 11-06-2018): Find a better way to do this
                # self.data = data
         ...
         if ok:
            if len(text) > 0:
                ...
                if (self.nrows * self.ncols) >= len(self.par):
                    ...
                    QtGui.QMessageBox.information(self, "Information", 
                    "Product of Rows and Columns should match the current number of parameters on viewgraph")
    ...
    def saveFile(self, newVals, sKey, unitMeasurement, numPrecisionX, numPrecisionY):  
        ...
        # TODO (11-06-2018) put this block of code in a try except block
        tmpFile = []
        ...
        if ok:
            ...
            if len(text) > 0:
                ...
                try:
                    ...
                    QtGui.QMessageBox.information(self, "Information", 
                    "{} is not installed or configured properly on this system.".format(programName))
            else:
    ...
    def updateScale(self):
        ...
        for i in self.gwObjects:
            if i.par == argKeys[counter]:
                ...
                counter += 1
                # TODO the first plot function should be invoked here
        self.sm.close
    ...
    def editParamDef(self):
        ...
        if (len(str(self.ps.parameter.currentText()))>0 and
            ...
            try:
                ...
                QtGui.QMessageBox.information(self, "Information", 
                        "This parameter does not exist. Add to view it.")
            else:
    ...
    def tirificMessage(self):
        ...
        """
        QtGui.QMessageBox.information(self, "Information", 
                "Data cube ("+self.INSET+") specified at INSET doesn't exist in specified directory.")
