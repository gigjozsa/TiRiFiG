...
#        self.openFile.setShortcut("Ctrl+O")
        openFile.setStatusTip('Load .def file to be plotted')
        openFile.triggered.connect(self.openDef)
        
        saveChanges = QtGui.QAction("&Save", self)
#        openEditor.setShortcut("Ctrl+S")
        saveChanges.setStatusTip('Save changes to .def file')
        saveChanges.triggered.connect(self.saveAll)
